 ...
 * @file tcr_session.h
 * 
 * @brief This interface represents a session between the client and the TCR server.
 */
 class __declspec(dllexport) TcrSession {
 public:
   /**
     * @brief Session event definitions.
     *
     * @see Observer#onEvent(Event, Object)
     */
    enum class Event {
        /**
         * @brief This event indicates that the session has been initialized.
         *
        ...
        STATE_INITED,
        /**
         * @brief This event indicates that the session is connected.
         *
         * This event has no associated data.
         */
        STATE_CONNECTED,
        /**
         * @brief This event indicates that the session is closed, and thus it can not be used any more.
         *
        ...
        /**
         * @brief This event indicates that the performance data is updated. 
         *
        ...
        /**
         * @brief This event indicates that the status of the game process on the server has been changed.
         *
         * The associated event data is of type string in json format:
         * {
        ...
        GAME_START_COMPLETE,
        /**
         * @brief This event indicates the status of the archive loading in the server.
         *
         * The associated event data is of type String in json format:
         * {
         *     user_id: string,      // The user ID
        ...
        ARCHIVE_LOAD_STATUS,
        /**
         * @brief This event indicates the status of the archive saving in the server.
         *
         * The associated event data is of type String in json format:
         * {
         *     user_id: String      // The user ID
        ...
        /**
         * @brief This event indicates that the input status of the server has changed. 
         *
         * The associated event data is of type string in json format:
         * {
        ...
        /**
         * @brief This event indicates that the remote desktop information is updated. 
         *
         * The associated event data is of type string in json format:
         * {
        ...
        REMOTE_DESKTOP_INFO,
        /**
         * @brief This event indicates that the configuration of the cloud screen configuration has been changed.<br>
         *
        ...
        /**
         * @brief This event indicates that the remote cursor image information is updated.
         *
         * The associated event data is of type string in json format:
         * {
        ...
        CURSOR_IMAGE_INFO,
        /**
         * @brief This event indicates that the showing status of cloud cursor is changed. 
         *
         * The associated event data is of type string in json format:
         * {
  ...
  public:
      /**
        * @brief This will be called when some event happened in the session.
        *
