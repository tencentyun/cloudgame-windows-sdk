...
#ifndef CLOUD_GAMING_PC_TCRSDKPROJECT_TCRSDK_API_TCR_TYPES_H_
#define CLOUD_GAMING_PC_TCRSDKPROJECT_TCRSDK_API_TCR_TYPES_H_
 ...
 */
typedef void (*TcrUploadProgressCallback)(const char* instance_id, double total_bytes, double transferred_bytes,
                                          void* user_data);
...
#endif  // CLOUD_GAMING_PC_TCRSDKPROJECT_TCRSDK_API_TCR_TYPES_H_