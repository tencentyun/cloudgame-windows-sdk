...
LoginViewModel::LoginViewModel(ApiService* apiService, QObject* parent) : QObject(parent), m_apiService(apiService) {
  Logger::info("LoginViewModel initialized");
}

bool LoginViewModel::isBusy() const { return m_isBusy; }
