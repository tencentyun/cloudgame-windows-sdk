...
class StreamConfig : public QObject {
  ...
  Q_PROPERTY(int mainStreamMinBitrate READ mainStreamMinBitrate WRITE setMainStreamMinBitrate NOTIFY
                 mainStreamMinBitrateChanged)
  Q_PROPERTY(int mainStreamMaxBitrate READ mainStreamMaxBitrate WRITE setMainStreamMaxBitrate NOTIFY
                 mainStreamMaxBitrateChanged)
  ...
  Q_PROPERTY(
      int subStreamMinBitrate READ subStreamMinBitrate WRITE setSubStreamMinBitrate NOTIFY subStreamMinBitrateChanged)
  Q_PROPERTY(
      int subStreamMaxBitrate READ subStreamMaxBitrate WRITE setSubStreamMaxBitrate NOTIFY subStreamMaxBitrateChanged)
