...
QByteArray NetworkService::getToken() const { return m_token; }

void NetworkService::setToken(const QByteArray& token) { m_token = token; }

void NetworkService::setRequestHost(const QString& requestHost) { m_requestHost = requestHost; }

void NetworkService::setOrigin(const QString& origin) { m_origin = origin; }
